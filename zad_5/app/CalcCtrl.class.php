...
class CalcCtrl {
	...
	public function getParams(){
		...
		$this->form->wysokosc_oprocentowania = isset($_REQUEST ['wysokosc_oprocentowania']) ? $_REQUEST ['wysokosc_oprocentowania'] : null;
	}
	...
	public function process(){
		...
		if ($this->validate()) {
			...
			$this->msgs->addInfo('Obliczono wysokosc raty.');
		}
		$this->generateView();
	}
