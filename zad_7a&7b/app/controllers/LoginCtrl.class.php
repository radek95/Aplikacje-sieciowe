...
class LoginCtrl{
	...
	public function validate() {
		...
		if (! (isset ( $this->form->login ) && isset ( $this->form->passsword ))) {
		...
		if ( !getMessages()->isError() ) {
			...
			if ($this->form->login == "admin" && $this->form->passsword == "admin") {
			...
			} else if ($this->form->login == "user" && $this->form->passsword == "user") {
